...
export const stellen: Stelle[] = [
  ...
  {
    slug: 'werkstudent-cloud',
    titel: 'Werkstudent (m/w/d) im Bereich Cloud & Software',
    standort: 'Wiesbaden',
    modell: 'Hybrid',
    kurzbeschreibung: 'Unterstütze unser Team bei Cloud-Projekten und sammle Praxiserfahrung in Entwicklung und Betrieb.',
    beschreibung: 'Als Werkstudent:in arbeitest du an echten Cloud-Projekten mit: du hilfst bei der Entwicklung von Web-Anwendungen, bei Automatisierungen und beim Aufbau von Monitoring. Ideal für den Berufseinstieg in Cloud und Software.',
    aufgaben: [
      'Mitarbeit an der Entwicklung von Web- und Cloud-Anwendungen',
      'Unterstützung bei Deployments und CI/CD-Pipelines',
      'Auswertung von Monitoring- und Kostendaten',
      'Technische Dokumentation von Architektur und Prozessen',
    ...
    voraussetzungen: [
      ...
      'Interesse an Cloud-Technologien, Containern und Automatisierung',
    ...
    benefits: [
      ...
      'Mentoring durch erfahrene Cloud-Engineers',
